...
RESULTS_DIR    = config.RESULTS_SVM_DIR
CHECKPOINT_DIR = os.path.join(config.BASE_DIR, "checkpoints_svm")
CACHE_DIR      = os.path.join(config.BASE_DIR, "cache_svm")
...
def run_pipeline():
    ...
    print(f"SVM")
    print(f"SVC C={SVM_C} kernel={SVM_KERNEL} gamma={SVM_GAMMA}")
